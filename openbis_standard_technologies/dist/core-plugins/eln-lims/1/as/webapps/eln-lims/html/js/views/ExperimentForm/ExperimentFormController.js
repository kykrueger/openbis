...
function ExperimentFormController(mainController, mode, experiment) {
	...
	this.updateExperiment = function() {
		...
		var experimentSpace = Util.getSpaceCodeFromIdentifier(this._experimentFormModel.experiment.identifier);
		var experimentProject = Util.getProjectCodeFromExperimentIdentifier(this._experimentFormModel.experiment.identifier);
		var experimentCode = this._experimentFormModel.experiment.code;
		var experimentIdentifier = Util.getExperimentIdentifier(experimentSpace, experimentProject, experimentCode);
