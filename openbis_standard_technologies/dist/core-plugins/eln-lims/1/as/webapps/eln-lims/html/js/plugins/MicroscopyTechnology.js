...
$.extend(MicroscopyTechnology.prototype, ELNLIMSPlugin.prototype, {
	...
	sampleFormTop : function($container, model) {
		if(model.datasets && model.datasets.length > 0 && profile.isImageViewerDataSetCode(model.datasets[0].dataSetTypeCode)) {
				...
				var widget = new ImageViewerWidget(screningFacade, [model.datasets[0].code]);
