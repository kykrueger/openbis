...
class VocabularyDefinitionToCreationParser(object):
    ...
    def parse(definition):
        ...
        vocabulary_creation.setCode(code)
        if code.startswith(u'$'):
            vocabulary_creation.setInternalNameSpace(True)
...
class PropertyAssignmentDefinitionToCreationParser(object):
    ...
    def parse(property):
        ...
        property_assingment_creation.setPropertyTypeId(PropertyTypePermId(code))
        dynamic_script_path = property[u'dynamic script']
        if dynamic_script_path is not None:
            property_assingment_creation.setPluginId(PluginPermId(ScriptDefinitionToCreationParser.get_name_for(code, dynamic_script_path)))
...
class SampleTypeDefinitionToCreationParser(object):
    ...
    def parse(definition):
        ...
        if validation_script_path is not None:
            sample_creation.setValidationPluginId(PluginPermId(ScriptDefinitionToCreationParser.get_name_for(code, validation_script_path)))
    ...
    def parse(definition):
        ...
        for sample_properties in definition.properties:
            ...
            if u'$' in sample_properties and sample_properties[u'$'] is not None:
                ...
                sample_creation.setCreationId(CreationId(sample_properties[u'$']))
            ...
            if u'parents' in sample_properties and sample_properties[u'parents'] is not None:
                ...
                sample_creation.setParentIds(parent_creationids)
            if u'children' in sample_properties and sample_properties[u'children'] is not None:
                ...
                sample_creation.setChildIds(child_creationids)
...
class ScriptDefinitionToCreationParser(object):
    ...
    def parse(definition):
        ...
        if validation_script_path is not None:
            ...
            script_file.close()
            validation_script_creation.setName(ScriptDefinitionToCreationParser.get_name_for(code, validation_script_path))
        ...
        for property in definition.properties:
            ...
            if dynamic_prop_script_path is not None:
                ...
                script = script_file.read()
                script_file.close()
                validation_script_creation.setName(ScriptDefinitionToCreationParser.get_name_for(code, dynamic_prop_script_path))
                validation_script_creation.setScript(script)
