...
/**
 * Interface to be implemented if you want to set a different <code>IFormatParameterFactory</code> in {@link FormatParameters}.
 * 
...
public interface IFormatParameterFactory
{
     ...
     * 
     * @return <code>null</code> if no appropriate <code>FormatParameter</code> could be created from given <code>INode</code>.
     */
     ...
     * 
     * @param name name of the format parameter. Usually it is one of the values returned by {@link Format#getMandatoryParameterNames()}.
     * @param value generic value that should help to construct the <code>FormatParameter</code>.
     * @return <code>null</code> if no appropriate <code>FormatParameter</code> could be created from given <code>value</code>.
     */
