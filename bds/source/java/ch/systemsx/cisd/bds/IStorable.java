 ...
 * <p>
 * Note that each implementation should have a <code>static</code> method <code>loadFrom(IDirectory)</code> that knows how to construct itself from
 * given <code>IDirectory</code>.
 * </p>
 * 
