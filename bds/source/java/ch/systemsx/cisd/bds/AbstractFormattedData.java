...
public abstract class AbstractFormattedData implements IFormattedData
{
    ...
    /**
     * Asserts valid format and format parameters. Will be called at the end of the constructor. The format of the {@link FormattedDataContext} will
     * be available by the protected attribute {@link #format}. The format parameters will be available by {@link #getFormatParameters()}.
     * 
