...
/**
 * Exception thrown if some problem occurred during operations in the Storage API which can not be
 * classified convincingly as an {@link EnvironmentFailureException}.
 * 
