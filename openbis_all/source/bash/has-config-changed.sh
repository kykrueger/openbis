...
compare_configs $CONFIG_DIR/service.properties $SERVER_DIR/etc/classes/service.properties
compare_configs $CONFIG_DIR/openbis.conf $SERVER_DIR/etc/openbis.conf
