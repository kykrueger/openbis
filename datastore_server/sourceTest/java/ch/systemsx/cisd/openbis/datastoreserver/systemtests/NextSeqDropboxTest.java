 ...
 * @author kohleman
 */
public class NextSeqDropboxTest extends SystemTestCase
{
    // for jython script go to
    // qgf-dropboxes/source/core-plugins/illumina-qgf/1/dss/drop-boxes/register-lane-nextseq/register-lane-nextseq.py
    ...
    {
        createData("success");
        waitUntilDataSetImported(new LogMonitoringStopConditionBuilder(new DropBoxNameCondition("register-lane-nextseq"))
...
//    }
    ...
    private void createData(String fileName) throws Exception
    {
        ...
        File dataDirectory = new File(workingDirectory, "register-lane-nextseq-" + fileName);
    ...
    {
        return new File(rootDir, "register-lane-nextseq");
    }
