 ...
 * @author pkupczyk
 */
public class DataSetCodeCollectionPredicateSystemTest extends CommonDataSetPredicateSystemTest<String>
{
    ...
    {
        getBean(DataSetPredicateTestService.class).testDataSetCodeCollectionPredicate(sessionProvider, objects);
    }
