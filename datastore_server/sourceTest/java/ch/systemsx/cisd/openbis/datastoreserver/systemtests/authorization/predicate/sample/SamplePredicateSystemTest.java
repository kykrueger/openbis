 ...
 * @author pkupczyk
 */
public class SamplePredicateSystemTest extends CommonSamplePredicateSystemTest<Sample>
{
    ...
    {
        getBean(SamplePredicateTestService.class).testSamplePredicate(sessionProvider, objects.get(0));
    }
