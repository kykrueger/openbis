 ...
 * @author Bernd Rinn
 */
public class BioFormatsImageUtils
{
    ...
    private static IFormatReader findReader(String name) throws IOException,
     ...
     * @throws IllegalArgumentException If no suitable reader can be found.
     */
    public static BufferedImage readImage(String filename, IRandomAccess handle, int page)
            throws IOExceptionUnchecked, IllegalArgumentException
    {
        // Add to static map.
     ...
     * @throws IllegalArgumentException If no suitable reader can be found.
     */
    public static BufferedImage[] readImages(String filename, IRandomAccess handle)
            throws IOExceptionUnchecked, IllegalArgumentException
    {
