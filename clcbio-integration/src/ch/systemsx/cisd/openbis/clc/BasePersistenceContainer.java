 ...
 * @author anttil
 */
public abstract class BasePersistenceContainer extends BasePersistenceStructure implements PersistenceContainer
{

    public BasePersistenceContainer(String name, PersistenceContainer parent, PersistenceModel model)
    {
    ...
    public Authenticator getAuthenticator()
    {
        ...
        return new OpenBISAuthenticator();
    }
    ...
    public File export(PersistenceStructure arg0, File arg1, PersistenceTransaction arg2) throws PersistenceException
    {
        ...
        throw new PersistenceException("export not implemented");
    }
    ...
    @Override
    public abstract Iterator<PersistenceStructure> list() throws PersistenceException;
