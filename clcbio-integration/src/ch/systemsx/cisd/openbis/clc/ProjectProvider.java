 ...
 * @author anttil
 */
public class ProjectProvider implements ContentProvider
{
    ...
    public ProjectProvider(IOpenbisServiceFacade openbis, String space, List<String> projects)
    {
    ...
    public Collection<PersistenceStructure> getContent(PersistenceContainer parent, PersistenceModel model)
    {
        ...
        {
            result.add(new Folder(project, parent, model, new ExperimentProvider(openbis, space, project)));
        }
        return result;
    }
