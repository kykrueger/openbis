...
{
	var now_string = d3.time.format("%Y-%m-%d_%H-%M-%S")(new Date());
	var parameters = 
	{
		code : now_string,
	};

	openbisServer.createReportFromAggregationService("DSS1", "example-ingestion-service", parameters, displayReturnedTable);
}
