...
public class QueryDAOTest extends AbstractDAOTest
{
    ...
    public void testCreateQuery() throws Exception
    {
        ...
        QueryPE query = createQuery("q1", "test query", "select * from blabla", true, getSystemPerson());
    ...
    private QueryPE createQuery(String name, String description, String expression, boolean isPublic, PersonPE registrator)
    {
