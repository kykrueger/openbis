 ...
 */
public final class ListRoles extends AbstractDefaultTestCommand
{
    ...
    public final void execute()
    {
        ...
        GWTTestUtil.selectMenuCategoryWithID(LeftMenu.ID, CategoriesBuilder.CATEGORIES.ROLES);

        GWTTestUtil.selectMenuWithID(LeftMenu.ID, CategoriesBuilder.CATEGORIES.ROLES,
