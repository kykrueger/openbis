 ...
 * @author pkupczyk
 */
public class ExperimentIdPredicateWithAugmentedCodeSystemTest extends CommonPredicateSystemTest<ExperimentIdentifierId>
{
    ...
    {
        return new ExperimentIdentifierId(ExperimentDB.getIdentifier(spacePE, projectPE));
    }
