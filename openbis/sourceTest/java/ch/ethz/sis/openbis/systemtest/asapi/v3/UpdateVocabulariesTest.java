...
public class UpdateVocabulariesTest extends AbstractTest
{
    ...
    public void testUpdateDescription()
    {
        ...
        assertEquals(vocabulary.isInternalNameSpace(), false);
        assertEquals(vocabulary.isManagedInternally(), false);
    ...
    public void testUpdateAll()
    {
        ...
        // Then
        VocabularyFetchOptions fetchOptions = new VocabularyFetchOptions();
        VocabularyPermId id2 = new VocabularyPermId("$ORGANISM");
        Vocabulary vocabulary = v3api.getVocabularies(sessionToken, Arrays.asList(id2), fetchOptions).get(id2);
        assertEquals(vocabulary.getDescription(), update.getDescription().getValue());
        assertEquals(vocabulary.getPermId(), id2);
        assertEquals(vocabulary.getCode(), id2.getPermId());
        assertEquals(vocabulary.isChosenFromList(), false);
        assertEquals(vocabulary.isInternalNameSpace(), true);
