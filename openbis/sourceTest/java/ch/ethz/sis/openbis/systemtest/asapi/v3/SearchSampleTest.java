...
// TODO: enable this test when search by sample properties is enabled.
//    @Test
//    public void testSearchWithSampleProperties()
//    {
//        final String sessionToken = v3api.login(TEST_USER, PASSWORD);
...
//        v3api.createSamples(sessionToken, Arrays.asList(creation)).get(0);
//
//        final SampleSearchCriteria criteria = new SampleSearchCriteria();
//        criteria.withOrOperator();
