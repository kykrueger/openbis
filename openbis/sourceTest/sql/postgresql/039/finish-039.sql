...
REVOKE ALL ON SEQUENCE authorization_group_id_seq FROM izabelaa;
GRANT ALL ON SEQUENCE authorization_group_id_seq TO izabelaa;
...
REVOKE ALL ON SEQUENCE authorization_group_person_id_seq FROM izabelaa;
GRANT ALL ON SEQUENCE authorization_group_person_id_seq TO izabelaa;
...
REVOKE ALL ON TABLE authorization_group_persons FROM izabelaa;
GRANT ALL ON TABLE authorization_group_persons TO izabelaa;
...
REVOKE ALL ON TABLE authorization_groups FROM izabelaa;
GRANT ALL ON TABLE authorization_groups TO izabelaa;
