...
CREATE SEQUENCE data_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
SELECT pg_catalog.setval('data_id_seq', 15, true);
...
CREATE SEQUENCE data_set_property_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
SELECT pg_catalog.setval('data_set_property_id_seq', 15, true);
...
CREATE SEQUENCE deletion_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
SELECT pg_catalog.setval('deletion_id_seq', 5, false);
...
CREATE SEQUENCE experiment_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
SELECT pg_catalog.setval('experiment_id_seq', 21, true);
