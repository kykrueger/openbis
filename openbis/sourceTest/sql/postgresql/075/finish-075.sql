...
CREATE INDEX data_del_fk_i ON data USING btree (del_id);
...
CREATE INDEX expe_del_fk_i ON experiments USING btree (del_id);
...
CREATE INDEX samp_del_fk_i ON samples USING btree (del_id);
