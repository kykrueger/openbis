...
CREATE VIEW data AS
    SELECT data_all.id, data_all.code, data_all.dsty_id, data_all.dast_id, data_all.expe_id, data_all.data_producer_code, data_all.production_timestamp, data_all.samp_id, data_all.registration_timestamp, data_all.pers_id_registerer, data_all.pers_id_modifier, data_all.is_placeholder, data_all.is_valid, data_all.modification_timestamp, data_all.is_derived, data_all.ctnr_order, data_all.ctnr_id, data_all.del_id, data_all.version FROM data_all WHERE (data_all.del_id IS NULL);
CREATE VIEW data_deleted AS
    SELECT data_all.id, data_all.code, data_all.dsty_id, data_all.dast_id, data_all.expe_id, data_all.data_producer_code, data_all.production_timestamp, data_all.samp_id, data_all.registration_timestamp, data_all.pers_id_registerer, data_all.pers_id_modifier, data_all.is_placeholder, data_all.is_valid, data_all.modification_timestamp, data_all.is_derived, data_all.ctnr_order, data_all.ctnr_id, data_all.del_id, data_all.version FROM data_all WHERE (data_all.del_id IS NOT NULL);
...
CREATE SEQUENCE property_type_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
SELECT pg_catalog.setval('property_type_id_seq', 27, true);
...
CREATE SEQUENCE stpt_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
SELECT pg_catalog.setval('stpt_id_seq', 15, true);
