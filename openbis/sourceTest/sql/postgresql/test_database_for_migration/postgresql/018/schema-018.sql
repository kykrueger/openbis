...
CREATE DOMAIN boolean_char_or_unknown AS character(1)
...
CREATE SEQUENCE data_set_relationship_id_seq
    ...
    NO MINVALUE
    CACHE 1;
SELECT pg_catalog.setval('data_set_relationship_id_seq', 1, true);
...
CREATE SEQUENCE experiment_attachment_id_seq
    ...
    NO MINVALUE
    CACHE 1;
SELECT pg_catalog.setval('experiment_attachment_id_seq', 5, false);
...
CREATE SEQUENCE invalidation_id_seq
    ...
    NO MINVALUE
    CACHE 1;
SELECT pg_catalog.setval('invalidation_id_seq', 1, true);
...
CREATE SEQUENCE material_property_id_seq
    ...
    NO MINVALUE
    CACHE 1;
SELECT pg_catalog.setval('material_property_id_seq', 27823, true);
...
CREATE SEQUENCE sample_input_id_seq
    ...
    NO MINVALUE
    CACHE 1;
SELECT pg_catalog.setval('sample_input_id_seq', 9, true);
CREATE SEQUENCE sample_property_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
SELECT pg_catalog.setval('sample_property_id_seq', 75, true);
...
CREATE SEQUENCE scma_id_seq
    ...
    NO MINVALUE
    CACHE 1;
SELECT pg_catalog.setval('scma_id_seq', 21321, true);
