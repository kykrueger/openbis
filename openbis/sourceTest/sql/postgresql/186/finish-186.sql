...
CREATE UNIQUE INDEX data_set_properties_unique_value ON data_set_properties USING btree (dstpt_id, value, cvte_id, mate_prop_id, samp_prop_id) WHERE is_unique;
...
CREATE UNIQUE INDEX experiment_properties_unique_value ON experiment_properties USING btree (etpt_id, value, cvte_id, mate_prop_id, samp_prop_id) WHERE is_unique;
...
CREATE UNIQUE INDEX material_properties_unique_value ON material_properties USING btree (mtpt_id, value, cvte_id, mate_prop_id) WHERE is_unique;
...
CREATE UNIQUE INDEX sample_properties_unique_value ON sample_properties USING btree (stpt_id, value, cvte_id, mate_prop_id, samp_prop_id) WHERE is_unique;
