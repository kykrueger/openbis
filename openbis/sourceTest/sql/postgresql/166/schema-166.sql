...
SELECT pg_catalog.setval('role_assignment_id_seq', 27, true);
...
SELECT pg_catalog.setval('semantic_annotation_id_seq', 2, false);
SELECT pg_catalog.setval('space_id_seq', 3, true);
SELECT pg_catalog.setval('stpt_id_seq', 20, true);
