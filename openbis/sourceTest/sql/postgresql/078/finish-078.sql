...
REVOKE ALL ON TABLE data_deleted FROM buczekp;
GRANT ALL ON TABLE data_deleted TO buczekp;
...
REVOKE ALL ON TABLE experiments_deleted FROM buczekp;
GRANT ALL ON TABLE experiments_deleted TO buczekp;
...
REVOKE ALL ON TABLE samples_deleted FROM buczekp;
GRANT ALL ON TABLE samples_deleted TO buczekp;
