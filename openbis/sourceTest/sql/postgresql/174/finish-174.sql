...
ALTER TABLE ONLY content_copies
    ADD CONSTRAINT coco_data_fk FOREIGN KEY (data_id) REFERENCES link_data(id);
ALTER TABLE ONLY content_copies
...
ALTER TABLE ONLY link_data
    ADD CONSTRAINT lnda_data_fk FOREIGN KEY (id) REFERENCES data_all(id) ON DELETE CASCADE;
ALTER TABLE ONLY material_properties
