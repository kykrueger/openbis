...
CREATE VIEW data AS
    SELECT data_all.id, data_all.code, data_all.dsty_id, data_all.dast_id, data_all.expe_id, data_all.data_producer_code, data_all.production_timestamp, data_all.samp_id, data_all.registration_timestamp, data_all.access_timestamp, data_all.pers_id_registerer, data_all.pers_id_modifier, data_all.is_placeholder, data_all.is_valid, data_all.modification_timestamp, data_all.is_derived, data_all.ctnr_order, data_all.ctnr_id, data_all.del_id, data_all.orig_del, data_all.version FROM data_all WHERE (data_all.del_id IS NULL);
CREATE VIEW data_deleted AS
    SELECT data_all.id, data_all.code, data_all.dsty_id, data_all.dast_id, data_all.expe_id, data_all.data_producer_code, data_all.production_timestamp, data_all.samp_id, data_all.registration_timestamp, data_all.access_timestamp, data_all.pers_id_registerer, data_all.pers_id_modifier, data_all.is_placeholder, data_all.is_valid, data_all.modification_timestamp, data_all.is_derived, data_all.ctnr_order, data_all.ctnr_id, data_all.del_id, data_all.orig_del, data_all.version FROM data_all WHERE (data_all.del_id IS NOT NULL);
...
CREATE SEQUENCE experiment_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
SELECT pg_catalog.setval('experiment_id_seq', 24, true);
...
CREATE SEQUENCE material_type_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
SELECT pg_catalog.setval('material_type_id_seq', 10, true);
...
CREATE SEQUENCE mtpt_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
SELECT pg_catalog.setval('mtpt_id_seq', 28, true);
...
CREATE SEQUENCE sample_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
SELECT pg_catalog.setval('sample_id_seq', 1060, true);
...
CREATE SEQUENCE stpt_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
SELECT pg_catalog.setval('stpt_id_seq', 16, true);
