...
ALTER TABLE ONLY metaproject_assignments
    ADD CONSTRAINT metaproject_assignments_mepr_id_data_id_uk UNIQUE (mepr_id, data_id);
ALTER TABLE ONLY metaproject_assignments
    ADD CONSTRAINT metaproject_assignments_mepr_id_expe_id_uk UNIQUE (mepr_id, expe_id);
ALTER TABLE ONLY metaproject_assignments
    ADD CONSTRAINT metaproject_assignments_mepr_id_mate_id_uk UNIQUE (mepr_id, mate_id);
ALTER TABLE ONLY metaproject_assignments
    ADD CONSTRAINT metaproject_assignments_mepr_id_samp_id_uk UNIQUE (mepr_id, samp_id);
ALTER TABLE ONLY metaproject_assignments
    ADD CONSTRAINT metaproject_assignments_pk PRIMARY KEY (id);
...
CREATE INDEX metaproject_assignments_mepr_fk_i ON metaproject_assignments USING btree (mepr_id);
...
ALTER TABLE ONLY metaproject_assignments
    ADD CONSTRAINT metaproject_assignments_data_id_fk FOREIGN KEY (data_id) REFERENCES data_all(id) ON DELETE CASCADE;
ALTER TABLE ONLY metaproject_assignments
    ADD CONSTRAINT metaproject_assignments_expe_id_fk FOREIGN KEY (expe_id) REFERENCES experiments_all(id) ON DELETE CASCADE;
ALTER TABLE ONLY metaproject_assignments
    ADD CONSTRAINT metaproject_assignments_mate_id_fk FOREIGN KEY (mate_id) REFERENCES materials(id) ON DELETE CASCADE;
ALTER TABLE ONLY metaproject_assignments
    ADD CONSTRAINT metaproject_assignments_mepr_id_fk FOREIGN KEY (mepr_id) REFERENCES metaprojects(id) ON DELETE CASCADE;
ALTER TABLE ONLY metaproject_assignments
    ADD CONSTRAINT metaproject_assignments_samp_id_fk FOREIGN KEY (samp_id) REFERENCES samples_all(id) ON DELETE CASCADE;
ALTER TABLE ONLY metaprojects
...
REVOKE ALL ON TABLE data FROM gpawel;
GRANT ALL ON TABLE data TO gpawel;
GRANT SELECT ON TABLE data TO openbis_readonly;
REVOKE ALL ON TABLE data_deleted FROM PUBLIC;
REVOKE ALL ON TABLE data_deleted FROM gpawel;
GRANT ALL ON TABLE data_deleted TO gpawel;
GRANT SELECT ON TABLE data_deleted TO openbis_readonly;
REVOKE ALL ON TABLE data_set_relationships FROM PUBLIC;
REVOKE ALL ON TABLE data_set_relationships FROM gpawel;
GRANT ALL ON TABLE data_set_relationships TO gpawel;
GRANT SELECT ON TABLE data_set_relationships TO openbis_readonly;
REVOKE ALL ON SEQUENCE deletion_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE deletion_id_seq FROM gpawel;
GRANT ALL ON SEQUENCE deletion_id_seq TO gpawel;
GRANT SELECT ON SEQUENCE deletion_id_seq TO openbis_readonly;
REVOKE ALL ON TABLE experiments FROM PUBLIC;
REVOKE ALL ON TABLE experiments FROM gpawel;
GRANT ALL ON TABLE experiments TO gpawel;
GRANT SELECT ON TABLE experiments TO openbis_readonly;
REVOKE ALL ON TABLE experiments_deleted FROM PUBLIC;
REVOKE ALL ON TABLE experiments_deleted FROM gpawel;
GRANT ALL ON TABLE experiments_deleted TO gpawel;
GRANT SELECT ON TABLE experiments_deleted TO openbis_readonly;
REVOKE ALL ON TABLE grid_custom_columns FROM PUBLIC;
REVOKE ALL ON TABLE grid_custom_columns FROM gpawel;
GRANT ALL ON TABLE grid_custom_columns TO gpawel;
...
REVOKE ALL ON SEQUENCE grid_custom_columns_id_seq FROM gpawel;
GRANT ALL ON SEQUENCE grid_custom_columns_id_seq TO gpawel;
...
REVOKE ALL ON SEQUENCE metaproject_assignment_id_seq FROM gpawel;
GRANT ALL ON SEQUENCE metaproject_assignment_id_seq TO gpawel;
...
REVOKE ALL ON TABLE metaproject_assignments FROM gpawel;
GRANT ALL ON TABLE metaproject_assignments TO gpawel;
GRANT SELECT ON TABLE metaproject_assignments TO openbis_readonly;
REVOKE ALL ON SEQUENCE metaproject_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE metaproject_id_seq FROM gpawel;
GRANT ALL ON SEQUENCE metaproject_id_seq TO gpawel;
GRANT SELECT ON SEQUENCE metaproject_id_seq TO openbis_readonly;
REVOKE ALL ON TABLE metaprojects FROM PUBLIC;
REVOKE ALL ON TABLE metaprojects FROM gpawel;
GRANT ALL ON TABLE metaprojects TO gpawel;
GRANT SELECT ON TABLE metaprojects TO openbis_readonly;
REVOKE ALL ON SEQUENCE relationship_type_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE relationship_type_id_seq FROM gpawel;
GRANT ALL ON SEQUENCE relationship_type_id_seq TO gpawel;
GRANT SELECT ON SEQUENCE relationship_type_id_seq TO openbis_readonly;
REVOKE ALL ON TABLE relationship_types FROM PUBLIC;
REVOKE ALL ON TABLE relationship_types FROM gpawel;
GRANT ALL ON TABLE relationship_types TO gpawel;
...
REVOKE ALL ON SEQUENCE sample_relationship_id_seq FROM gpawel;
GRANT ALL ON SEQUENCE sample_relationship_id_seq TO gpawel;
...
REVOKE ALL ON TABLE sample_relationships_all FROM gpawel;
GRANT ALL ON TABLE sample_relationships_all TO gpawel;
GRANT SELECT ON TABLE sample_relationships_all TO openbis_readonly;
REVOKE ALL ON TABLE sample_relationships FROM PUBLIC;
REVOKE ALL ON TABLE sample_relationships FROM gpawel;
GRANT ALL ON TABLE sample_relationships TO gpawel;
GRANT SELECT ON TABLE sample_relationships TO openbis_readonly;
REVOKE ALL ON TABLE samples FROM PUBLIC;
REVOKE ALL ON TABLE samples FROM gpawel;
GRANT ALL ON TABLE samples TO gpawel;
GRANT SELECT ON TABLE samples TO openbis_readonly;
REVOKE ALL ON TABLE samples_deleted FROM PUBLIC;
REVOKE ALL ON TABLE samples_deleted FROM gpawel;
GRANT ALL ON TABLE samples_deleted TO gpawel;
GRANT SELECT ON TABLE samples_deleted TO openbis_readonly;
REVOKE ALL ON SEQUENCE script_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE script_id_seq FROM gpawel;
GRANT ALL ON SEQUENCE script_id_seq TO gpawel;
GRANT SELECT ON SEQUENCE script_id_seq TO openbis_readonly;
REVOKE ALL ON TABLE scripts FROM PUBLIC;
REVOKE ALL ON TABLE scripts FROM gpawel;
GRANT ALL ON TABLE scripts TO gpawel;
