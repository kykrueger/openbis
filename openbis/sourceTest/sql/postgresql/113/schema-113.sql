...
CREATE DOMAIN data_set_kind AS character varying(40)
	CONSTRAINT data_set_kind_check CHECK (((VALUE)::text = ANY ((ARRAY['EXTERNAL'::character varying, 'LINK'::character varying, 'CONTAINER'::character varying])::text[])));
...
CREATE SEQUENCE data_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
SELECT pg_catalog.setval('data_id_seq', 22, true);
