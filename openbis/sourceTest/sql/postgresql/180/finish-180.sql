...
CREATE TRIGGER data_all_tsvector_document BEFORE INSERT OR UPDATE ON data_all FOR EACH ROW EXECUTE PROCEDURE tsvector_update_trigger('tsvector_document', 'pg_catalog.simple', 'data_set_kind', 'code');
...
CREATE TRIGGER experiments_all_tsvector_document BEFORE INSERT OR UPDATE ON experiments_all FOR EACH ROW EXECUTE PROCEDURE tsvector_update_trigger('tsvector_document', 'pg_catalog.simple', 'perm_id', 'code');
...
CREATE TRIGGER materials_tsvector_document BEFORE INSERT OR UPDATE ON materials FOR EACH ROW EXECUTE PROCEDURE tsvector_update_trigger('tsvector_document', 'pg_catalog.simple', 'code');
...
CREATE TRIGGER samples_all_tsvector_document BEFORE INSERT OR UPDATE ON samples_all FOR EACH ROW EXECUTE PROCEDURE tsvector_update_trigger('tsvector_document', 'pg_catalog.simple', 'perm_id', 'code');
