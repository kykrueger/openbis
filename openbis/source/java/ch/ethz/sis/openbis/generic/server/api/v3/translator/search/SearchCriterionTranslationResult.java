 ...
 * @author pkupczyk
 */
public class SearchCriterionTranslationResult
{
    ...
    public SearchCriterionTranslationResult(DetailedSearchCriterion criterion)
    {
        this.criterionList = new DetailedSearchCriterion[] { criterion };
    }

    public SearchCriterionTranslationResult(DetailedSearchCriterion... criterionList)
    {
        this.criterionList = criterionList;
    }

    public SearchCriterionTranslationResult(DetailedSearchSubCriteria criteria)
    {
        this.subCriteriaList = new DetailedSearchSubCriteria[] { criteria };
    }

    public SearchCriterionTranslationResult(DetailedSearchSubCriteria... criteriaList)
    {
        this.subCriteriaList = criteriaList;
    }

    public SearchCriterionTranslationResult(DetailedSearchCriteria criteria)
    {
        this.criteriaList = new DetailedSearchCriteria[] { criteria };
    }

    public SearchCriterionTranslationResult(DetailedSearchCriteria... criteriaList)
    {
