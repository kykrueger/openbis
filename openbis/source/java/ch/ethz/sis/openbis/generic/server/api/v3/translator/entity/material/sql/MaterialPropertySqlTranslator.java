 ...
 */
@Component
public class MaterialPropertySqlTranslator extends
        AbstractCachingTranslator<IEntityPropertiesHolder, Map<String, Material>, MaterialFetchOptions> implements IMaterialPropertySqlTranslator
{
    ...
    protected Map<String, Material> createObject(TranslationContext context, IEntityPropertiesHolder entity, MaterialFetchOptions fetchOptions)
    {
        ...
        for (EntityPropertyPE property : entity.getProperties())
        {
            if (property.getMaterialValue() != null)
            {
                ...
                Material material = materialTranslator.translate(context, materialPe.getId(), fetchOptions);
