 ...
 */
public class ExperimentSearchManager extends AbstractCompositeEntitySearchManager<ExperimentSearchCriteria, Long>
{
    ...
    @Override
    protected ExperimentSearchCriteria createEmptyCriteria()
    {
