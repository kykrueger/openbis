...
public class SamplePartOfSearchCriteriaTranslator implements IConditionTranslator<SampleContainerSearchCriteria>
{
    @Override
            ...
            final IAliasFactory aliasFactory)
    {
        ...
        final String containerTableAlias = aliasFactory.createAlias();
        ...
        joinInformation.setMainTableIdField(PART_OF_SAMPLE_COLUMN);
        joinInformation.setSubTable(tableMapper.getEntitiesTable());
        joinInformation.setSubTableAlias(containerTableAlias);
        joinInformation.setSubTableIdField(ID_COLUMN);
        result.put(tableMapper.getEntitiesTable(), joinInformation);
