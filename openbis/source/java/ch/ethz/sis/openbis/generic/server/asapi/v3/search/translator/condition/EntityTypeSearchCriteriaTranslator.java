...
public class EntityTypeSearchCriteriaTranslator implements IConditionTranslator<AbstractEntityTypeSearchCriteria>
{

    @Override
    public Map<String, JoinInformation> getJoinInformationMap(final AbstractEntityTypeSearchCriteria criterion, final EntityMapper entityMapper,
