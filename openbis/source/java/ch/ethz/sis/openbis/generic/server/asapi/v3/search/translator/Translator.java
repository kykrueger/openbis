...
public class Translator
{
    ...
    static
    {
        ...
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(DescriptionSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(IdentifierSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        ...
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(ExternalCodeSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(GitCommitHashSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(GitRepositoryIdSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(LocationSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(PathSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(ShareIdSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(AddressSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(LabelSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(EmailSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(FirstNameSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(LastNameSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(UserIdSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(EntityTypeCodePatternSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(SqlSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(DescriptorAccessionIdSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(DescriptorOntologyIdSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(DescriptorOntologyVersionSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(PredicateAccessionIdSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(PredicateOntologyIdSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(PredicateOntologyVersionSearchCriteria.class, stringFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(NumberFieldSearchCriteria.class, numberFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(TechIdSearchCriteria.class, numberFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(SizeSearchCriteria.class, numberFieldSearchCriteriaTranslator);
        CRITERIA_TO_CONDITION_TRANSLATOR_MAP.put(SpeedHintSearchCriteria.class, numberFieldSearchCriteriaTranslator);
