...
public class LinkExtractor
{
    ...
    public static final String tryExtract(Object o)
    {
    ...
    {
        if (s == null || s.getPermId() == null)
        {
            return null;
        }
        return "entity=SAMPLE&permId=" + s.getPermId();
    }

    public static final String tryExtract(Experiment e)
    {
        if (e == null || e.getPermId() == null)
        {
            return null;
        }
        return "entity=EXPERIMENT&permId=" + e.getPermId();
    }
    ...
    public static String tryExtract(ExternalData e)
    {
        ...
        return "entity=DATA_SET&permId=" + e.getPermId();
    }
}
