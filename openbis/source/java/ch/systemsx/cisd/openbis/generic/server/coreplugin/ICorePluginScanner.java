...
/**
 * The {@link ICorePluginScanner} abstracts the physical representation of a {@link CorePlugin} on
 * the file system.
 * 
 * @author Kaloyan Enimanev
 */
public interface ICorePluginScanner
{
    /**
     * Lists all core plugins available on the file system.
     */
    List<CorePlugin> scanForPlugins();
