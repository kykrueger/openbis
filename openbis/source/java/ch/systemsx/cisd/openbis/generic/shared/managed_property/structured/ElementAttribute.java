...
public class ElementAttribute implements IElementAttribute
{
    ...
    {
        assert Pattern.matches("[a-zA-Z]\\w*", key) : "Attribute names must be non-emtpy strings "
                + "containing characters from the English alphabet.";
    ...
    {
        assert value != null : "Attribute values cannot be null";
        this.value = value;
    }
