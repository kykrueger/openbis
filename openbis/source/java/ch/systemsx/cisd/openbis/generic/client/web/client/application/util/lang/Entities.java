 ...
 * </p>
 * <p>
 * To update this to a new version of apache.commons.lang add an inner {@link StringWriter} class to
 * the class code and remove throws IOException declaration everywhere. To remove warnings add
 * {@link SuppressWarnings} annotation on the class and some {@link Override} annotations on a few
