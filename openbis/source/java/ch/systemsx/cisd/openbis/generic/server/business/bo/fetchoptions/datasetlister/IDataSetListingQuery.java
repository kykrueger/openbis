...
public interface IDataSetListingQuery extends BaseQuery
{
    ...
    @Select(sql = "select"
            ...
            + " ld.external_code as ld_external_code, edms.id as edms_id, edms.code as edms_code, edms.label as edms_label, edms.address as edms_address, edms.address_type as edms_address_type"
