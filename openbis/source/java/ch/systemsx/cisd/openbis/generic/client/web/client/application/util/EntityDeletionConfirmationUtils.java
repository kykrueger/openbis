...
public class EntityDeletionConfirmationUtils
{
    ...
    public static String getMessageForSingleSample(SampleChildrenInfo sampleChildrenInfo)
    {
        ...
        {
            additionalMessage.append("<br>The sample has " + sampleChildrenInfo.getChildCount()
                    + " children samples, these relationships will be broken but the children will remain:");
        ...
        {
            additionalMessage.append("<br>The sample has " + sampleChildrenInfo.getDataSetCount()
                    + " datasets, these will be deleted with the sample:");
            additionalMessage.append("<br>");
    ...
    public static String getMessageForMultipleSamples(List<SampleChildrenInfo> sampleChildrenInfo, Map<String, String> techIdsToSampleIds)
    {
        ...
        if (samplesWithChildren > 0)
        {
            additionalMessage.append("<br>There are " + samplesWithChildren
                    + " sample(s) with children samples, these relationships will be broken but the children will remain:<br>");
        ...
        {
            additionalMessage
                    .append("<br>There are " + samplesWithDataSets + " sample(s) with data sets, these will be deleted with the sample:<br>");
