...
public class SampleOwnerFinder
{
     ...
     * the owners id.
     */
    public static class SampleOwner
    {
        ...
        public SampleOwner(GroupPE groupOrNull, DatabaseInstancePE databaseInstanceOrNull)
        {
        ...
        public static SampleOwner createGroup(GroupPE group)
        {
