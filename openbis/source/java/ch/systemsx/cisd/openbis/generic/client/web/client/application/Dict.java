...
public abstract class Dict {
	...
	public static final String PERFORM_COMPUTATION_ON_SELECTED_OR_ALL_DATASETS_MSG_TEMPLATE = "perform_computation_on_selected_or_all_datasets_msg_template";

	public static final String PERFORM_ARCHIVING_ON_ALL_DATASETS_MSG_TEMPLATE = "perform_archiving_on_all_datasets_msg_template";

	public static final String PERFORM_ARCHIVING_ON_SELECTED_OR_ALL_DATASETS_MSG_TEMPLATE = "perform_archiving_on_selected_or_all_datasets_msg_template";

	public static final String PERFORM_ARCHIVING_ON_ALL_DATASETS_CONNECTED_TO_EXPERIMENTS_MSG_TEMPLATE = "perform_archiving_on_all_datasets_connected_to_experiments_msg_template";

	public static final String PERFORM_ARCHIVING_ON_SELECTED_OR_ALL_DATASETS_CONNECTED_TO_EXPERIMENTS_MSG_TEMPLATE = "perform_archiving_on_selected_or_all_datasets_connected_to_experiments_msg_template";
	...
	public static final String DELETE_VOCABULARY_TERMS_CONFIRMATION_MESSAGE_NO_REPLACEMENTS_SINGULAR = "delete_vocabulary_terms_confirmation_message_no_replacements_singular";

	public static final String DELETE_VOCABULARY_TERMS_CONFIRMATION_MESSAGE_NO_REPLACEMENTS = "delete_vocabulary_terms_confirmation_message_no_replacements";

	public static final String DELETE_VOCABULARY_TERMS_CONFIRMATION_MESSAGE_FOR_REPLACEMENTS = "delete_vocabulary_terms_confirmation_message_for_replacements";
	...
	public static final String MAKE_OFFICIAL_VOCABULARY_TERMS_CONFIRMATION_MESSAGE_SINGULAR = "make_official_vocabulary_terms_confirmation_message_singular";
	...
	public static final String REMOVE_PERSONS_FROM_AUTHORIZATION_GROUP_CONFIRMATION_TITLE = "remove_persons_from_authorization_group_confirmation_title";

	public static final String REMOVE_PERSONS_FROM_AUTHORIZATION_GROUP_CONFIRMATION_MESSAGE = "remove_persons_from_authorization_group_confirmation_message";
