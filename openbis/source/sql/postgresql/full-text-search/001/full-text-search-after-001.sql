...
ALTER TABLE projects
    ENABLE TRIGGER MELT_PROJECT_FOR,
    ENABLE TRIGGER PROJECT_FROZEN_CHECK_ON_DELETE,
    ENABLE TRIGGER ADD_PROJECT_TO_SPACE_CHECK,
    ENABLE TRIGGER PROJECT_SPACE_RELATIONSHIP_FROZEN_CHECK;
