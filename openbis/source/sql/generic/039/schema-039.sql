...
ALTER TABLE AUTHORIZATION_GROUP_PERSONS ADD CONSTRAINT AGP_PK PRIMARY KEY(ID);
...
ALTER TABLE EVENTS ADD CONSTRAINT EVNT_BK_UK UNIQUE(EVENT_TYPE,ENTITY_TYPE,IDENTIFIER);
...
ALTER TABLE AUTHORIZATION_GROUP_PERSONS ADD CONSTRAINT AGP_BK_UK UNIQUE(PERS_ID,AG_ID);
