...
ALTER TABLE ROLE_ASSIGNMENTS ADD CONSTRAINT ROAS_PE_SPACE_PROJECT_BK_UK UNIQUE(PERS_ID_GRANTEE,ROLE_CODE,SPACE_ID,PROJECT_ID);
ALTER TABLE ROLE_ASSIGNMENTS ADD CONSTRAINT ROAS_AG_SPACE_PROJECT_BK_UK UNIQUE(AG_ID_GRANTEE,ROLE_CODE,SPACE_ID,PROJECT_ID);
