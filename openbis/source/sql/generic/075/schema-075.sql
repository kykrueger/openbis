...
CREATE TABLE DELETIONS (ID TECH_ID NOT NULL,PERS_ID_REGISTERER TECH_ID NOT NULL,REGISTRATION_TIMESTAMP TIME_STAMP_DFL NOT NULL DEFAULT CURRENT_TIMESTAMP,REASON DESCRIPTION_2000);
...
ALTER TABLE DATA ADD CONSTRAINT DATA_DEL_FK FOREIGN KEY (DEL_ID) REFERENCES DELETIONS(ID);
...
ALTER TABLE EXPERIMENTS ADD CONSTRAINT EXPE_DEL_FK FOREIGN KEY (DEL_ID) REFERENCES DELETIONS(ID);
...
ALTER TABLE SAMPLES ADD CONSTRAINT SAMP_DEL_FK FOREIGN KEY (DEL_ID) REFERENCES DELETIONS(ID);
...
CREATE INDEX DATA_DEL_FK_I ON DATA (DEL_ID);
...
CREATE INDEX EXPE_DEL_FK_I ON EXPERIMENTS (DEL_ID);
...
CREATE INDEX SAMP_DEL_FK_I ON SAMPLES (DEL_ID);
