...
CREATE TABLE EXTERNAL_DATA_MANAGEMENT_SYSTEMS (ID TECH_ID, CODE CODE, LABEL TEXT_VALUE, URL_TEMPLATE TEXT_VALUE, IS_OPENBIS BOOLEAN DEFAULT FALSE NOT NULL);
