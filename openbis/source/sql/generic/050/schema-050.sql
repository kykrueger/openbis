...
CREATE TABLE EXTERNAL_DATA (DATA_ID TECH_ID NOT NULL,LOCATION VARCHAR(1024) NOT NULL,FFTY_ID TECH_ID NOT NULL,LOTY_ID TECH_ID NOT NULL,CVTE_ID_STOR_FMT TECH_ID NOT NULL,IS_COMPLETE BOOLEAN_CHAR_OR_UNKNOWN NOT NULL DEFAULT 'U',CVTE_ID_STORE TECH_ID, IS_LOCKED BOOLEAN NOT NULL DEFAULT FALSE, STATUS VARCHAR(100) NOT NULL DEFAULT 'ACTIVE');
...
ALTER TABLE external_data ADD CONSTRAINT exda_status_enum_ck CHECK 
  (status IN ('LOCKED', 'ACTIVE', 'ARCHIVED', 'ACTIVATION_IN_PROGRESS', 'ARCHIVIZATION_IN_PROGRESS'));
