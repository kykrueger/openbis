...
import static ch.ethz.sis.microservices.download.server.services.store.StatisticsReceiverHandler.TIMESTAMP_FORMAT;
...
//        statisticsMap.put(StatisticsKeys.SUBMISSION_TIMESTAMP, TIMESTAMP_FORMAT.format(new Date()));
