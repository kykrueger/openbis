...
/**
 * A <code>IHCSImageFileExtractor</code> implementation suitable for <i>LMC</i> based on BDS (to be removed).
 * 
 * @author Tomasz Pylak
 */
public class BDSHCSImageFileExtractor extends AbstractHCSImageFileExtractor implements
        IHCSImageFileExtractor
{
    ...
    public BDSHCSImageFileExtractor(final Properties properties)
    {
        super(properties);
    }

    @Private
    BDSHCSImageFileExtractor(Geometry wellGeometry)
    {
        super(wellGeometry);
    }
