...
#
#file_type_HDF5 = tr.getOrCreateNewFileFormatType('HDF5')
#file_type_HDF5.setDescription('Hierarchical Data Format File, version 5')

#file_type_PROPRIETARY = tr.getOrCreateNewFileFormatType('PROPRIETARY')
#file_type_PROPRIETARY.setDescription('Proprietary Format File')

#file_type_SRF = tr.getOrCreateNewFileFormatType('SRF')
#file_type_SRF.setDescription('Sequence Read Format File')

#file_type_TIFF = tr.getOrCreateNewFileFormatType('TIFF')
#file_type_TIFF.setDescription('TIFF File')

#file_type_TSV = tr.getOrCreateNewFileFormatType('TSV')
#file_type_TSV.setDescription('Tab Separated Values File')

#file_type_XML = tr.getOrCreateNewFileFormatType('XML')
...
#
#vocabulary_STORAGE_FORMAT = tr.getOrCreateNewVocabulary('STORAGE_FORMAT')
