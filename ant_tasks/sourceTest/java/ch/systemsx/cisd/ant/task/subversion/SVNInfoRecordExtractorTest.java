...
{
    private static final List<String> INFO1 =
            Collections.unmodifiableList(Arrays.asList("Path: .",
                    "URL: svn+ssh://cisd-hal.ethz.ch/internal/cisd/ant_tasks/trunk",
                    "Repository Root: svn+ssh://cisd-hal.ethz.ch/internal",
                    "Repository UUID: e2bb8bc7-4a29-0410-9445-bbee19c747d1", "Revision: 290",
                    "Node Kind: directory", "Schedule: add", "Last Changed Author: felmer",
                    "Last Changed Rev: 255",
                    "Last Changed Date: 2007-05-07 16:27:11 +0200 (Mon, 07 May 2007)", ""));

    private static final List<String> INFO2 =
            Collections.unmodifiableList(Arrays.asList("Path: build",
                    "URL: svn+ssh://cisd-hal.ethz.ch/internal/cisd/ant_tasks/trunk/build",
                    "Repository Root: svn+ssh://cisd-hal.ethz.ch/internal",
                    "Repository UUID: e2bb8bc7-4a29-0410-9445-bbee19c747d1", "Revision: 290",
                    "Node Kind: directory", "Schedule: normal", "Last Changed Author: felmer",
                    "Last Changed Rev: 288",
                    "Last Changed Date: 2007-05-07 16:21:00 +0200 (Mon, 07 May 2007)", ""));

    private static final List<String> INFO3 =
            Collections
    ...
    public void testExtractingOfInfo3()
    {
        ...
        assertEquals("2007-05-07 16:22:00 +0200 (Mon, 07 May 2007)", infoRecord
                .getLastChangedDate());
    }
