...
/**
 * A provider for subversion project paths, either in a repository or a working copy. The provider
 * is based on a project context, that is the name, the version and the revision of a project.
 * 
 * @author Bernd Rinn
 */
interface ISVNProjectPathProvider
{
     ...
     * @param subProjectName The name of the sub project (interpreted in the context of this path
     *            provider). Must not contain any path delimiter.
     * @param entityPath The path of the entity relative to the context of this path provider. If it
     *            contains path delimiters, the delimiters will be converted as needed.
     * @return The absolute path of the <var>entityPath</var> for the <var>subProjectName</var> in
     *         the context of this path provider.
     * @throws UserFailureException If either the <var>subProjectName</var> or the <var>entityPath</var>
     *             are invalid.
     */
    ...
    /**
     * @return <code>true</code> if this provider represents a subversion repository path (rather
     *         than a working copy path).
     */
