...
<%MultipartRequest multi = new MultipartRequest(request, ".", 2 * 1024 * 1024);
String sequence = multi.getParameter("sequence");
sequence = Utility.removeUselessCharacter(sequence);
sequence = Utility.format(sequence);
%>
<html>
<head>
...
<title>PlasMapper - Formated Sequence</title>
	...
	<tr>
		...
		<table width="650" border="0" align="center" cellspacing="0"
			...
			<tr>
				...
				<textarea NAME="sequence" ROWS="8" COLS="80"><%=sequence%></textarea>
				<br>
