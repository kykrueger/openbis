...
import ch.systemsx.cisd.openbis.jstest.page.OpenbisJsWebapp;
 ...
 * @author pkupczyk
 */
public class OpenbisJsWebappLocation implements Location<OpenbisJsWebapp>
{
    ...
    @Override
    public Class<OpenbisJsWebapp> getPage()
    {
        return OpenbisJsWebapp.class;
    }
}