...
public class StartDataStoreServer
{
    ...
    public static void go(final String dssName) throws Exception
    {
        ...
        p.addListener(new Listener()
            {
                ...
                {
                    System.out.println("DSS " + dssName + ": " + line);
                }
            });
        ...
        System.out.println("DSS " + dssName + " STARTED");
                ...
                runtime.addShutdownHook(new Thread()
                    {
                        ...
                        public void run()
                        {
                            try
                            {
                                ...
                                process.destroy();
                                process.waitFor();
                                System.out.println("DSS DESTROYED");
                            } catch (Exception e)
                            {
                                e.printStackTrace();
                            }
