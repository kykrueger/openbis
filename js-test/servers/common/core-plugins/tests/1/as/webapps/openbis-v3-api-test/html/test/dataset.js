define([ 'jquery', 'openbis', 'test/common', 'dto/entity/dataset/DataSetUpdate', 'dto/id/dataset/DataSetPermId', 'dto/entity/dataset/ExternalDataUpdate', 'dto/id/dataset/FileFormatTypePermId' ],
		function($, openbis, common, DataSetUpdate, DataSetPermId, ExternalDataUpdate, FileFormatTypePermId) {
			return function() {
				...
				QUnit.test("updateDataSets()", function(assert) {
					...
					var externalUpdate = new ExternalDataUpdate();
					externalUpdate.setFileFormatTypeId(new FileFormatTypePermId("TIFF"));
