...
define(function() {
	return function() {
		...
		var checkDateFieldSearchCriterionMethod = function(criterion, methodName, basicClassName, methodDescription, name, type) {
			...
			try {
				...
				equal(e.message, "Date value: " + methodDescription + " to 'abc' does not match any of " + "the supported formats: YYYY-MM-DD,YYYY-MM-DD HH:mm,YYYY-MM-DD HH:mm:ss", "Error message");
			}
		}
		...
		var checkDateFieldSearchCriterion = function(criterionClassName, name, type) {
			require([ 'dto/search/' + criterionClassName ], function(Criterion) {
				...
				checkDateFieldSearchCriterionMethod(criterion, "thatIsLaterThanOrEqualTo", "LaterThanOrEqualToValue", "later than or equal", name, type);
				checkDateFieldSearchCriterionMethod(criterion, "thatIsEarlierThanOrEqualTo", "EarlierThanOrEqualToValue", "earlier than or equal", name, type);
				start();
			});
		}
