...
public class OwnerChooser
{
    ...
    public OwnerChooser(Component component, DataSetOwnerType ownerType, String sessionToken,
    ...
    public String getOwnerOrNull()
    {
        ...
        final ChooserTreeModel chooserTreeModel = new ChooserTreeModel(ownerType, sessionToken, service);
    ...
    private void setOwner(JTree tree)
    {
