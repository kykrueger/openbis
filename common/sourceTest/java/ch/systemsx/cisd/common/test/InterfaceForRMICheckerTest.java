...
public class InterfaceForRMICheckerTest
{
    ...
    public static class ClassWithExtendingClassWithNonSerializableAttribute extends ClassWithNonSerializableAttribute
    {
        private static final long serialVersionUID = 1L;
    }
    ...
    {
        assertEquals(NonSerializableClass.class + " does not implements java.io.Serializable", e.getMessage());
    }
