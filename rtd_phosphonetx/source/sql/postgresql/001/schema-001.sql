...
CREATE TABLE ANNOTATIONS(
 ...
 PROTEIN_DESCRIPTION SHORT_DESCRIPTION NOT NULL,
 IPI_NAME CODE,
 REFSEQ_NAME CODE,
 SWISSPROT_NAME CODE,
 ENSEMBL_NAME CODE,
 TREMBL_NAME CODE,
 LOCUS_LINK_NAME CODE,
 FLYBASE CODE
)
WITH (OIDS=FALSE)
;

ALTER TABLE ANNOTATIONS ADD CONSTRAINT ANNO_PK PRIMARY KEY (ID)
;
...
;
ALTER TABLE ANNOTATIONS ADD CONSTRAINT AN_PR_FK FOREIGN KEY (PROT_ID) REFERENCES PROTEINS (ID) ON DELETE NO ACTION ON UPDATE NO ACTION
;
