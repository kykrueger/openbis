...
ALTER TABLE MODIFICATIONS ADD CONSTRAINT MO_MP_FK FOREIGN KEY (MOPE_ID) REFERENCES MODIFIED_PEPTIDES (ID);
...
ALTER TABLE MODIFIED_PEPTIDES ADD CONSTRAINT MO_PE_FK FOREIGN KEY (PEPT_ID) REFERENCES PEPTIDES (ID);

CREATE INDEX IX_MP_AB_FK_MODIFIED_PEPTIDES ON MODIFIED_PEPTIDES (ABUN_ID);
ALTER TABLE MODIFIED_PEPTIDES ADD CONSTRAINT MP_AB_FK FOREIGN KEY (ABUN_ID) REFERENCES ABUNDANCES (ID);

CREATE INDEX IX_MO_ID_FK_MODIFIED_PEPTIDES ON MODIFIED_PEPTIDES (IDDA_ID);
ALTER TABLE MODIFIED_PEPTIDES ADD CONSTRAINT MO_ID_FK FOREIGN KEY (IDDA_ID) REFERENCES IDENTIFICATION_DATA (ID);
...
CREATE INDEX IX_PR_DA_FK_PROTEINS ON PROTEINS (DASE_ID);
