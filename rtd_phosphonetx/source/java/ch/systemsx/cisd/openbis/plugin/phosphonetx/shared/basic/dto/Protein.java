 ...
 */
public class Protein implements IsSerializable
{
    private AccessionNumberType accessionNumberType;

    private String accessionNumber;

    private String description;

    public final AccessionNumberType getAccessionNumberType()
    {
        return accessionNumberType;
    }

    public final void setAccessionNumberType(AccessionNumberType accessionNumberType)
    {
