...
class TypeSearch extends React.Component {
  ...
  async loadObjectTypes() {
    ...
    const types = this.filter(result.objects).map(object => ({
  ...
  filter(objects) {
    ...
    if (searchText) {
      return objects.filter(
        object =>
          (object.code &&
            object.code.toUpperCase().includes(searchText.toUpperCase())) ||
          (object.description &&
            object.description.toUpperCase().includes(searchText.toUpperCase()))
      )
    } else {
      return objects
    }
