...
class TypeFormParametersType extends React.PureComponent {
  ...
  renderObjectTypeAttributes(type) {
    if (TypeFormControllerStrategies.isObjectType(type.objectType)) {
      return (
        <React.Fragment>
  ...
  renderDataSetTypeAttributes(type) {
    if (TypeFormControllerStrategies.isDataSetType(type.objectType)) {
      return (
        <React.Fragment>
