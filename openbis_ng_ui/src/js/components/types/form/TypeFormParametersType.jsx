    ...
    return (
      <div className={classes.field}>
        <SelectField
          ...
          error={type.validationPlugin.error}
    ...
    return (
      <div className={classes.field}>
        <CheckboxField
          ...
          name='showContainer'
          error={type.showContainer.error}
    ...
    return (
      <div className={classes.field}>
        <CheckboxField
          ...
          error={type.showParentMetadata.error}
    ...
    return (
      <div className={classes.field}>
        <TextField
          ...
          mandatory={true}
          error={type.generatedCodePrefix.error}
    ...
    return (
      <div className={classes.field}>
        <CheckboxField
          ...
          error={type.autoGeneratedCode.error}
    ...
    return (
      <div className={classes.field}>
        <CheckboxField
          ...
          name='subcodeUnique'
          error={type.subcodeUnique.error}
    ...
    return (
      <div className={classes.field}>
        <CheckboxField
          ...
          error={type.disallowDeletion.error}
    ...
    return (
      <div className={classes.field}>
        <TextField
          ...
          error={type.mainDataSetPattern.error}
    ...
    return (
      <div className={classes.field}>
        <TextField
          ...
          error={type.mainDataSetPath.error}
