...
package ch.systemsx.cisd.authentication.jlan;
 ...
 * https://svn.alfresco.com/repos/alfresco-open-mirror/services/jlan/tags/6.0/alfresco-jlan/src/main/java/org/alfresco/jlan/server/auth/
 * EnterpriseCifsAuthenticator.java:
 * Validation of users using algorithm NTLMV2 has been extracted into the method 
 * {{@link #validateUserByNTLMv2(ClientInfo, ClientInfo, UserAccount, PasswordEncryptor, byte[])}. 
 * 
 * @author gkspencer
...
public class EnterpriseCifsAuthenticator extends CifsAuthenticator implements CallbackHandler
{
            ...
            throws SMBSrvException
    {
        ...
        if (user != null)
        {
            ...
            try
            {
                ClientInfo clientInfo = ClientInfo.createInfo(type3Msg.getUserName(), type3Msg.getNTLMHash());
                clientInfo.setDomain(type3Msg.getDomain());
                validateUserByNTLMv2(client, clientInfo, user, getEncryptor(), type2Msg.getChallenge());
            ...
            throws SMBSrvException
    {
        ...
        if (user != null)
        {
            ...
            try
            {
                ...
                validateUserByNTLMv2(client, client, user, getEncryptor(), srvChallenge);
    ...
    public void validateUserByNTLMv2(ClientInfo originalClient, ClientInfo client, UserAccount user, 
            PasswordEncryptor encryptor, byte[] challenge)
    {
        CifsAuthenticationUtils.validateUserByNTLMv2(client, user, encryptor, challenge);
    }
