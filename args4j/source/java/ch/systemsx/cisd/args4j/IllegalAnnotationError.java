 ...
 * <p>
 * This only happens when there's something wrong with the way you use args4j in your code, not when
 * the arguments supplied by the user is wrong. Hence this class is an {@link Error}.
 * 
