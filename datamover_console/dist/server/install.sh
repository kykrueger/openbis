...
zip -u "$installation_folder"/datamover_console.war "$war_classes"/service.properties "$war_classes"/etc/log.xml
cp -p "$installation_folder"/datamover_console.war "$jetty_folder"/webapps
rm -rf WEB-INF
