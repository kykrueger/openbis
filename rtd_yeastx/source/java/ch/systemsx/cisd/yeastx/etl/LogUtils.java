...
class LogUtils
{
    ...
    {
        notificationLog.error(String.format(messageFormat, arguments));
    }

    public static void warn(String messageFormat, Object... arguments)
    {
        operationLog.warn(String.format(messageFormat, arguments));
    }

    public static void info(String messageFormat, Object... arguments)
    {
        operationLog.info(String.format(messageFormat, arguments));
    }
}
