...
/**
 * A default data set info extractor enriched with file name property extraction.
 * 
 * @author Tomasz Pylak
 */
public class DataSetInfoExtractorYeastX implements IDataSetInfoExtractor
{
    private final IDataSetInfoExtractor defaultExtractor;

    private final DataSetInfoFileNameDecorator fileNameDecorator;

    public DataSetInfoExtractorYeastX(final Properties globalProperties)
    {
