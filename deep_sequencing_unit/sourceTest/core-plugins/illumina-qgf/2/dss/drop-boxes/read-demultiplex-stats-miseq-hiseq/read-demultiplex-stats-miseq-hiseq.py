...
#     print(index1list)
    ...
    for s in pre_filtered_list:
        ...
        if index2search == INDEX_EMPTY or index2search == INDEX_UNKNOWN:
            ...
            index2 = [ index2 for index2 in index2list if (index2search) == index2 ]
            try:
                index2 = index2[0]
            except: 
  ...
  JavaClassToProcessXML = read_demultiplex_stats_miseq_hiseq() # this function is implemented as Class in Java:
